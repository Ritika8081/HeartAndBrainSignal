...
import { Activity, Brain, Heart, Box, Moon, Sun, Info } from "lucide-react";
import { useBleStream } from "../components/Bledata";
import WebglPlotCanvas, {
  WebglPlotCanvasHandle,
} from "../components/WebglPlotCanvas";
...
export default function SignalVisualizer() {
  ...
  const datastream = useCallback((data: number[]) => {
    ...
    if (previousCounter !== null && data[0] !== (previousCounter + 1) % 256) {
      console.warn(
        `Data loss detected! Previous: ${previousCounter}, Current: ${data[0]}`
      );
    }
    previousCounter = data[0];
  }, []);

  const { counters, connected, connect, disconnect } = useBleStream(datastream);
  ...
  return (
    <div
      className={`flex flex-col h-screen ${bgGradient} transition-colors duration-300`}
    >
      <header
        className={`${
          darkMode
        ...
        } shadow-lg p-2 transition-colors duration-300`}
      >
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl font-light tracking-tight">
              ...
              <span className={`${primaryAccent} font-medium ml-1`}>
                Medusa
              </span>
            </h1>
          </div>
          <div className="flex items-center space-x-4">
            ...
            <button className="p-1 rounded-full transition-all duration-300 bg-stone-200 hover:bg-stone-300 text-stone-700 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-3 h-full">
          ...
          <div className="md:col-span-1 flex flex-col h-full gap-3">
            ...
            >
              {/* Icon box */}
              <div
                className={`p-3 rounded-full mb-2 ${iconBoxBg} transition-colors duration-300`}
              >
            ...
            >
              {/* Device status */}
              <h3 className={`text-base font-semibold mb-2 ${textPrimary}`}>
                Device Status
              </h3>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className={`font-medium text-xs ${textPrimary}`}>
                    000
                  </span>
                </div>
                <div className="flex justify-between items-center">
          ...
          <div className="md:col-span-2 flex flex-col gap-2">
            ...
            <div className="md:col-span-2 flex flex-col gap-2 ">
              {/* Chart container */}
              <div
                className={`h-30 max-h-[300px] rounded-xl overflow-hidden p-2 transition-colors duration-300  ${
                  darkMode ? "bg-zinc-800/90" : "bg-white"
                }`}
              >
                <WebglPlotCanvas
                  ref={canvaseeg1Ref}
          ...
          <div className="md:col-span-2 flex flex-col gap-2">
            ...
            >
              <div
                className={`p-3 rounded-full mb-1 ${heartIconBoxBg} transition-colors duration-300`}
              >
            ...
            <div className="md:col-span-2 flex flex-col gap-3">
              <div
                className={`h-62 max-h-[300px] rounded-xl overflow-hidden p-2 transition-colors duration-300  ${
                  darkMode ? "bg-zinc-800/90" : "bg-white"
                }`}
              >
                <WebglPlotCanvas
